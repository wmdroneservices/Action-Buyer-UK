-- Combined customer quote rule:
-- no item can be accepted/refused until every non-decided item has an effective published offer.
-- Once every item has an effective published offer, the customer sees one combined quote.
