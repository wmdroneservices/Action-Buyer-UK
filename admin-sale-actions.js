document.addEventListener("DOMContentLoaded", () => {
  ...
  async function addReturnAction() {
    ...
    try {
      ...
      // The consolidated sale page can trigger its MutationObserver more than once
      // while the sale data is being rendered. Re-check after the async query so
      // only one return-shipment action can ever be inserted.
      if (card.querySelector("#create-return-shipment-from-outcome")) return;
