...
document.addEventListener("DOMContentLoaded",async()=>{
 ...
 const allowed={
   ...
   storefront:!!staff.can_access_purchasing||!!staff.can_access_sales||!!staff.can_manage_staff
 };
...
async function loadCatalogueSummary(supabase){
 ...
 }catch(err){console.error("Unable to load catalogue summary",err);if(message)message.textContent="Catalogue summary could not be loaded: "+(err?.message||"Unknown error");panel.hidden=false;
 }finally{catalogueLoadInProgress=false;}
}
