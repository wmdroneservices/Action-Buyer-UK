...
$('search')?.addEventListener('input',resetToFirstPage);$('manufacturer-filter')?.addEventListener('change',resetToFirstPage);$('category-filter')?.addEventListener('change',resetToFirstPage);$('status-filter')?.addEventListener('change',resetToFirstPage);$('pricing-filter')?.addEventListener('change',resetToFirstPage);document.addEventListener('DOMContentLoaded',load,{once:true});