...
function renderRetailers(){
  ...
  if(!retailerRows.length){body.innerHTML='<tr><td colspan="13">No market evidence recorded yet. Add UK NEW pricing evidence, UK used/reference evidence, and overseas reference evidence. Overseas prices never affect Online comparison.</td></tr>';return;}
