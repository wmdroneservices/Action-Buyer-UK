...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function populatePackages(modelId) {
    const options = {
      ...
      "mavic-2-pro": { "drone-only": "Drone only", "standard": "Standard Package", "fly-more": "Fly More Combo", "smart-controller": "With DJI Smart Controller", "fly-more-smart-controller": "Fly More Combo with Smart Controller" },
      "mavic-2-zoom": { "drone-only": "Drone only", "rc1-controller": "With RC1 Controller", "fly-more": "Fly More Combo", "smart-controller": "With Smart Controller" },
