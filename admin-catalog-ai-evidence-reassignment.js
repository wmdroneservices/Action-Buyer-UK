...
async function addPanel(card){
 ...
 panel.innerHTML='<summary>VALID EVIDENCE — WRONG TARGET DETECTED · ROUTE THIS EVIDENCE</summary><div class="ai-route-panel-body"><strong>Choose the correct catalogue product</strong><small>'+(reviewWrong?'You marked PRODUCT / MODEL / PACKAGE as AI WAS WRONG. The finding is being kept and can be routed here.':'This finding is being kept. Route it to the correct catalogue product instead of denying valid research.')+'</small><div class="ai-route-row"><input class="ai-route-search" type="search" placeholder="Search catalogue by manufacturer, model, package or keyword…"><select><option value="">Choose the correct catalogue product…</option></select><button type="button" class="btn btn-secondary">MOVE TO CORRECT PRODUCT</button></div><span class="ai-route-status" aria-live="polite"></span></div>';
